...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.example.mokey.weekport.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.example.mokey.weekport.db.table.Id>();

    /* package */
    static synchronized com.example.mokey.weekport.db.table.Id getId(Class<?> entityType) {
        ...
        com.example.mokey.weekport.db.table.Id id = new com.example.mokey.weekport.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.example.mokey.weekport.db.table.Id id = getId(entityType);
